...
@InputType()
class PackageModelCreateNestedManyWithoutCoursesInput {
...
export { PackageModelCreateNestedManyWithoutCoursesInput as PackageModelCreateNestedManyWithoutCoursesInput };
