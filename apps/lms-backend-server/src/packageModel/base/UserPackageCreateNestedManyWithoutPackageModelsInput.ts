...
@InputType()
class UserPackageCreateNestedManyWithoutPackageModelsInput {
...
export { UserPackageCreateNestedManyWithoutPackageModelsInput as UserPackageCreateNestedManyWithoutPackageModelsInput };
